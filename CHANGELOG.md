...
- Use wrong replacement technique in Alfred popup when Safari is in the forefront.

## 0.2.1

### Fixed

- Web page in Safari received synthetic events out of order, cause wrong Vietnamese typing.

## 0.2.0

### Added

- Toggle keyboard lock by shortcut: `Ctrl + Opt + Cmd + L` or selection on MenuBar.
